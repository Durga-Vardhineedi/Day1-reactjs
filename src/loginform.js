...
function Login(){
    ...
    const formSubmitted = (event) =>{
        ...
        if ((globalUserObject.collegeIdValue===firstValue) && (globalUserObject.passwordValue===secondValue)) {
            setResultMessage('Successful');
            setGlobalIsLogin(true);
            //localStorage.setItem("name","ReactJS");//storing the data.  
        } else {
    ...
    return(
        <div style={{display:"flex",alighItems:"center",justifyContent:"center",marginTop:"60px"}}>
        <div className="card" >
